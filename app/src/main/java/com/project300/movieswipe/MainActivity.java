...
//        final String username = GetUserID.getText().toString().trim();

//        Toast.makeText(getApplicationContext(), username, Toast.LENGTH_SHORT).show();

//        DatabaseReference mDatabaseReference = FirebaseDatabase.getInstance().getReference("users");
//        Query query = mDatabaseReference.orderByChild("name").equalTo(username);
//
...
//
//                    String title = (String) singleSnapshot.child("name").getValue().toString();
//                }
//            }
//
//            @Override
